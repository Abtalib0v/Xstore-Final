...
const BlogCategoryList = () => {
  ...
  const {
    ...
    mutationKey: QueryKeys.blogs.createCategory,
    mutationFn: async (data: any) => postApi("/blogs/create/category", data),
    onSuccess: () => {
      formik.resetForm();
      refetch();
...
await deleteAPiWithParams("blogs/categories", item._id);
              await refetch();
