"use client";
import { deleteAPiWithParams, getAPi, postApi } from "@/app/_http/api";
...
import { BasicTable } from "@/app/_common/Basictable";
import { CommonDialog } from "@/app/_common/Dialog";
...
const {
    ...
    mutationKey: QueryKeys.products.createProduct,
  ...
  const colums = ["id", "name", "price", "Desc", "image", "categories","actions"];
      ...
      return {
        ...
        actions: (
          <div className="flex items-center gap-1.5">
            ...
            await deleteAPiWithParams("products", item._id);
                          await refetch();
  ...
  return (
    <div>
      <div className="flex items-center my-5 justify-between">
        <h1 className="text-3xl font-bold text-gray-800">Products Lists </h1><div className="flex items-center justify-center w-full">
               {/* <CldUploadWidget
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="mb-4">
                ...
                />
                {formik.touched && formik.errors.star ? (
                  <div className="text-sm mt-1 font-medium text-red-500">
                    {formik.errors.star}
                  </div>
                ) : null}
